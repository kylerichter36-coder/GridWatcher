...
GridWatcher is an off-grid electrical grid monitoring system combining ESP32-C6 hardware, 868MHz LoRa radio telemetry, real ZMPT101B 230V AC True RMS sampling, an Orange Pi PC + eMMC Home Assistant server, and an automated Windows Machine Learning retrainer.
